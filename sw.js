/* ZEZMS Owner Edition v3.28.17 - Device-Local Dashboard KPI Layout r67Q */
const CACHE = 'zezms-r67q-device-local-kpi-layout-20260919';
const PATCHED_INDEX_CACHE = 'zezms-r67q-device-local-kpi-layout-cache-v1';
const ASSETS = [
...
self.addEventListener('message', (event) => {
  ...
  if (data && data.type === 'ZEZMS_R67Q_SHELL_READY' && data.release === '20260919-r67q-device-local-kpi-layout') {
