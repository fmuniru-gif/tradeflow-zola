/* ZEZMS Owner Edition v3.26.0 - Management Alerts & Action Prioritisation r65 */
const CACHE = 'zezms-management-alerts-20260906-r65';
const PATCHED_INDEX_CACHE = 'zezms-r65-management-alerts-cache-v1';
const ASSETS = [
