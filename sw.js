/* ZEZMS Owner Edition v3.25.0 - Targets, Forecasting & Scenario Planning r64 */
const CACHE = 'zezms-targets-forecasting-20260905-r64';
const PATCHED_INDEX_CACHE = 'zezms-r64-targets-forecasting-cache-v1';
const ASSETS = [
