/* ZEZMS Owner Edition v3.27.0 - Management Action Plans & Tasks r66 */
const CACHE = 'zezms-management-actions-20260906-r66';
const PATCHED_INDEX_CACHE = 'zezms-r66-management-actions-cache-v1';
const ASSETS = [
