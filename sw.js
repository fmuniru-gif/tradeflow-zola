/* ZEZMS Owner Edition v3.22.11 - Quick Sale Cash Buckets r60K1 */
const CACHE = 'zezms-quick-sale-cash-buckets-20260831-r60k1';
const PATCHED_INDEX_CACHE = 'zezms-r60k1-baseline-cache-v1';
const ASSETS = [
