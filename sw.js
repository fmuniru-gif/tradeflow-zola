/* ZEZMS Owner Edition v3.15.1 - Stage 6A UI and integration stabilization */
const CACHE = 'zezms-stage6a-ui-integration-fix-20260821-r50';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  ...
  './js/backup-manager.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/cloud-sync.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/input-defaults-v3130.js?v=20260821-stage6a-ui-integration-fix-r50',
  ...
  './js/operations-update.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/auto-month-rollover.js?v=20260812-portfolio-signals-r39',
  './js/invoice-waybill.js?v=20260821-stage6a-ui-integration-fix-r50',
  ...
  './js/owner-maintenance-v373.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/pdf-export.js?v=20260821-stage6a-ui-integration-fix-r50',
  ...
  './js/customer-master-v3120.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/customer-outreach-v3140.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/customer-followups-v3130.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/product-catalog-search-v3140.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/sales-pipeline-v3150.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/stock-corrections-v3150.js?v=20260821-stage6a-ui-integration-fix-r50',
  './js/warranty-management-v3150.js?v=20260821-stage6a-ui-integration-fix-r50',
  ...
  './js/navigation-v3101.js?v=20260821-stage6a-ui-integration-fix-r50',
];
